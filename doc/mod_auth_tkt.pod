...
secret used for hashing. May be global or specific to a virtual host.

=over 4

=item TKTAuthSecret <secret>

String - the secret used for hashing. This should be kept secret and 
changed periodically. e.g.
...
requires a version of Apache::AuthTkt >= 2.0.90.
